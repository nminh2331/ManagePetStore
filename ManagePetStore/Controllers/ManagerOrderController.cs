...
using OrderStatusHelper = ManagePetStore.Models.ManagerModels.OrderStatusHelper;
using ManagePetStore.Services.Customer;
using ManagePetStore.Models.CustomerModels;

[Authorize(Roles = "manager")]
[Route("Manager/Order/{action=Index}/{id?}")]
public class ManagerOrderController : Controller
{
    private readonly PetStoreManagementContext _context;

    public ManagerOrderController(PetStoreManagementContext context)
    {
        _context = context;
    }
