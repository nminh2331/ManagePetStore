...
[Authorize]
[Route("Customer/HotelBooking/{action=Index}/{id?}")]
public class CustomerHotelBookingController : Controller
{
    private static readonly string[] BlockingStatuses = ["Đã đặt", "Active", "Đang ở"];

    private readonly PetStoreManagementContext _context;
    private readonly ILogger<CustomerHotelBookingController> _logger;

    public CustomerHotelBookingController(
        PetStoreManagementContext context,
        ILogger<CustomerHotelBookingController> logger)
    {
        _context = context;
        _logger = logger;
    }
