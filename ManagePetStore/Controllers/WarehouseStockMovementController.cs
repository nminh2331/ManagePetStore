...
namespace ManagePetStore.Controllers
{
    ...
    [Route("Warehouse/StockMovement/{action=Index}/{id?}")]
public class WarehouseStockMovementController : Controller
    {
        ...
        public WarehouseStockMovementController(IStockMovementService movementService, IProductService productService, IProductCategoryService categoryService, ISupplierService supplierService)
        {
