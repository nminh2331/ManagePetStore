...
using ManagePetStore.Models.ServiceStaff;

namespace ManagePetStore.Controllers
{
    [Authorize(Roles = "service,admin,manager")]
    [Route("SpaServices")]
    public class ServiceStaffSpaServicesController : Controller
    {
        ...
        private readonly ILogger<ServiceStaffSpaServicesController> _logger;

        public ServiceStaffSpaServicesController(PetStoreManagementContext context, ILogger<ServiceStaffSpaServicesController> logger)
        {
            _context = context;
            _logger = logger;
        }
