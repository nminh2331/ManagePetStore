using OrderStatusHelper = ManagePetStore.Models.CustomerModels.OrderStatusHelper;
...
[Authorize]
[Route("Customer/Order/{action=Index}/{id?}")]
public class CustomerOrderController : Controller
{
    private readonly PetStoreManagementContext _context;
    private readonly IOrderReviewService _reviewService;

    public CustomerOrderController(PetStoreManagementContext context, IOrderReviewService reviewService)
    {
        _context = context;
