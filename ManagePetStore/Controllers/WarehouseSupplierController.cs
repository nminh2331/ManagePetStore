...
[Route("Warehouse/Supplier/{action=Index}/{id?}")]
public class WarehouseSupplierController : Controller
{
    private readonly ISupplierService _supplierService;
    private readonly IProductCategoryService _categoryService;

    public WarehouseSupplierController(ISupplierService supplierService, IProductCategoryService categoryService)
    {
